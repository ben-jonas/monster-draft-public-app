...
public class UpdateDraftStandUpPlayer extends AbstractUpdateDraftItemPattern {

  private final SessionAlias sessionAlias;
  private final int seat;

  public UpdateDraftStandUpPlayer(
  ...
  protected String updateExpression() {
    return "REMOVE #seatsToAliasesMap.#seat DELETE #seatedSet:aliasSs, #readySet:aliasSs";
  }
