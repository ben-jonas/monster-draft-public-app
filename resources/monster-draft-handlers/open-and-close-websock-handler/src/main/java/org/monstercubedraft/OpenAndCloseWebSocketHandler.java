  ...
  public APIGatewayV2WebSocketResponse handleRequest(
    ...
    try {
      ...
      if (routeKey.equals("$connect")) {
        ...
        System.out.printf("Non-connect / non-disconnect route key: %s\n", routeKey);
        return generateResponse(400);
      }
  ...
  private String connectUser(String wsConnectionId, Map<String, String> queryParams) {
    ...
    CommandResult result =
        sessionIdFromParams == null
            ? dynamoDbCommandService.connectToNewSession(wsConnectionId, gameId)
